...
for keymap, action in pairs({
  ...
  ["gd"] = { "lsp scope='definition'", desc = "Definition" },
  ["gD"] = { "lsp scope='declaration'", desc = "Declaration" },
  ["gi"] = { "lsp scope='implementation'", desc = "Implementation" },
  ["gr"] = { "lsp scope='references'", desc = "References" },
  ["gy"] = { "lsp scope='type_definition'", desc = "Type definition" },
